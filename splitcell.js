...
define([
	...
	var toggle_cell_style = function(){
		...
		if (!("cell_style" in cell.metadata)){cell.metadata.cell_style = 'split75';}
		else if (cell.metadata.cell_style == 'center'){cell.metadata.cell_style = 'split75';}
		else if (cell.metadata.cell_style == 'split75'){cell.metadata.cell_style = 'split50';}
		else if (cell.metadata.cell_style == 'split50'){cell.metadata.cell_style = 'split33';}
		else if (cell.metadata.cell_style == 'split33'){cell.metadata.cell_style = 'split25';}
	...
	var get_cell_style_html = function(cell_style){
		...
		if (cell_style == "split75") {return "float:left; width:75%;";}
		else if (cell_style == "split50") {return "float:left; width:50%;";}
		else if (cell_style == "split33") {return "float:left; width:33%;";}
		else if (cell_style == "split25") {return "float:left; width:25%;";}
		return "width:100%;";
	};
